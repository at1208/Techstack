...
const TechReducer = () => {
  return [
    { id: 0, name: 'Html', imgURL:'macfold.png', url:'macfold.png'},
    ...
    { id: 19,name: 'Bootstrap',imgURL:'macfold.png', url:'macfold.png'},
    ...
    { id: 28,name: 'OCaml',imgURL:'macfold.png', url:'macfold.png'},
